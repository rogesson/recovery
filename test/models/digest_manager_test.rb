...
class DigestManagerTest < ActionController::TestCase
	...
	test "should decript data" do
		dec_data = DigestManager.dec("U2FsdGVkX1+whxJ6lfx3BkvUdtrax6Q3DLwGrjHmRX7JEVp2dpmNAIt/q78vNdxn", "110019201920192")
		assert_equal "Um texto muito secreto", dec_data
	end
end